...
from core.model_catalog import MODEL_PRICING, ModelId
...
_sonnet_pricing = MODEL_PRICING[ModelId.CLAUDE_SONNET]
_haiku_pricing = MODEL_PRICING[ModelId.CLAUDE_HAIKU]
_gpt4o_pricing = MODEL_PRICING[ModelId.GPT_4O]

MODEL_REGISTRY: dict[str, ModelCapability] = {
    ModelId.CLAUDE_SONNET: ModelCapability(
        model_id=ModelId.CLAUDE_SONNET,
        provider="anthropic",
        governance_quality="validated",
        max_output_tokens=8192,
        supports_streaming=True,
        cost_per_1k_input=_sonnet_pricing.prompt_per_1k,
        cost_per_1k_output=_sonnet_pricing.completion_per_1k,
    ),
    ModelId.CLAUDE_HAIKU: ModelCapability(
        model_id=ModelId.CLAUDE_HAIKU,
        provider="anthropic",
        governance_quality="recommended",
        max_output_tokens=8192,
        supports_streaming=True,
        cost_per_1k_input=_haiku_pricing.prompt_per_1k,
        cost_per_1k_output=_haiku_pricing.completion_per_1k,
    ),
    ModelId.GPT_4O: ModelCapability(
        model_id=ModelId.GPT_4O,
        provider="openai",
        governance_quality="recommended",
        max_output_tokens=4096,
        supports_streaming=True,
        cost_per_1k_input=_gpt4o_pricing.prompt_per_1k,
        cost_per_1k_output=_gpt4o_pricing.completion_per_1k,
    ),
}
