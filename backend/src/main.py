...
from api.v1.analytics import (
    router as analytics_router,
)
from api.v1.designs import (
...
from api.v1.exports import (
    router as exports_router,
)
from api.v1.frameworks import (
    router as frameworks_router,
)
from api.v1.governance import (
...
from api.v1.topology import (
    router as topology_router,
)
from api.v1.workspaces import (
...
async def lifespan(app: FastAPI):  # type: ignore[no-untyped-def]
    ...
    # Pluggable tracing dispatcher
    dispatcher = initialize_tracing(settings)
    app.state.dispatcher = dispatcher
    dispatcher.configure_integrations(app)
